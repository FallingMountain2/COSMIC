...
function initExchangeRate() {
	...
	if (getHeight().gte(2)) game.rocket.exchangeRate = game.rocket.exchangeRate.times(getHeight().minus(2).times(10).pow(2).div(10));
	if (getHeight().gte(4)) game.rocket.exchangeRate = game.rocket.exchangeRate.times(getHeight().minus(4).times(10).pow(2).div(10));
